...
class TSaccessTC(EnvBasedTC):
    def setup_database(self):
        ...
        start_date = datetime(2009, 10, 1, 6)
        ...
        self.weeklyts = self.execute('INSERT TimeSeries SP: SP name "tsweekly", '
                               ...
                               'SP data %(d)s',
                               {'d': data,
                                's': datetime(2009, 10, 5, 6)}).get_entity(0, 0)

    def test_make_relative_index_daily(self):
        date = datetime(2009, 10, 2, 18)
    ...
    def test_get_by_date_monthly_slice(self):
        date1 = datetime(2009, 11, 2, 18)
        date2 = datetime(2010, 1, 4, 12)
    ...
    def test_get_by_date_yearly_slice(self):
        date1 = datetime(2010, 11, 2, 18)
        date2 = datetime(2013, 1, 4, 12)
    ...
    def test_get_by_date_weekly_slice(self):
        date1 = datetime(2009, 10, 14, 18)
        date2 = datetime(2009, 11, 2, 0)
    ...
    def test_aggregated_value_average(self):
        ...
        date2 = datetime(2009, 10, 4, 12)
        result = self.dailyts.aggregated_value(date1, date2, 'average')
...
class ComputeSumAverageTC(EnvBasedTC):
    ...
    def test_yearly_sum(self):
        start_date = datetime(2009, 10, 1, 6)
        end_date = datetime(2011, 10, 1, 6)
        sum_res = self.yearly_ts.aggregated_value(start_date, end_date, 'sum')
    ...
    def test_yearly_average(self):
        start_date = datetime(2009, 10, 1, 6)
        end_date = datetime(2011, 10, 1, 6)
        average = self.yearly_ts.aggregated_value(start_date, end_date, 'average')
        data = self.yearly_ts.array
        self.assertFloatAlmostEquals(average, (data[0] + data[1])/2)

    def test_monthly_sum(self):
        start_date = datetime(2009, 11, 3, 6)
        end_date = datetime(2010, 1, 23, 6)
        sum_res = self.monthly_ts.aggregated_value(start_date, end_date, 'sum')
    ...
    def test_monthly_average(self):
        start_date = datetime(2009, 11, 3, 6)
        end_date = datetime(2010, 1, 23, 6)
        average = self.monthly_ts.aggregated_value(start_date, end_date, 'average')
        data = self.monthly_ts.array
    ...
    def test_weekly_sum(self):
        start_date = datetime(2009, 10, 10, 6)
        end_date = datetime(2009, 10, 23, 6)
        sum_res = self.weekly_ts.aggregated_value(start_date, end_date, 'sum')
    ...
    def test_weekly_average(self):
        start_date = datetime(2009, 10, 10, 6)
        end_date = datetime(2009, 10, 23, 6)
        average = self.weekly_ts.aggregated_value(start_date, end_date, 'average')
        data = self.weekly_ts.array
        expected = (2/7*data[1] + 1*data[2] + 4/7*data[3]) / (2/7+1+4/7)
        self.assertFloatAlmostEquals(average, expected)

    def test_daily_sum(self):
        start_date = datetime(2009, 10, 3, 6)
        end_date = datetime(2009, 10, 23, 6)
        sum_res = self.daily_ts.aggregated_value(start_date, end_date, 'sum')
    ...
    def test_daily_average(self):
        start_date = datetime(2009, 10, 3, 6)
        end_date = datetime(2009, 10, 23, 6)
        average = self.daily_ts.aggregated_value(start_date, end_date, 'average')
        data = self.daily_ts.array
    ...
    def test_hourly_sum(self):
        start_date = datetime(2009, 10, 3, 6)
        end_date = datetime(2009, 10, 23, 6)
        sum_res = self.hourly_ts.aggregated_value(start_date, end_date, 'sum')
    ...
    def test_hourly_average(self):
        start_date = datetime(2009, 10, 3, 6)
        end_date = datetime(2009, 10, 23, 6)
        average = self.hourly_ts.aggregated_value(start_date, end_date, 'average')
        data = self.hourly_ts.array
    ...
    def test_15min_sum(self):
        start_date = datetime(2009, 10, 3, 6)
        end_date = datetime(2009, 10, 23, 6)
        sum_res = self.quart_ts.aggregated_value(start_date, end_date, 'sum')
